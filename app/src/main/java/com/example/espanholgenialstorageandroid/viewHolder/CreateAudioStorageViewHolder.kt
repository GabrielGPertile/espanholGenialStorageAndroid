...
class CreateAudioStorageViewHolder(activity: Activity)
{
    val ivAudio: ImageView = activity.findViewById(R.id.ivAudio)
    val tvAudioName: TextView = activity.findViewById(R.id.tvAudioName)
    val etAudioName: EditText = activity.findViewById(R.id.etAudioName)
