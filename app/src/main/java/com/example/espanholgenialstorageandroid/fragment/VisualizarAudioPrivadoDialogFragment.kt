...
class VisualizarAudioPrivadoDialogFragment : DialogFragment()
{
    ...
    companion object {
        ...
        fun newInstance(audioUrl: String, campoInformativo: String, nomeAudio: String): VisualizarAudioPrivadoDialogFragment {
            val fragment = VisualizarAudioPrivadoDialogFragment()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_visualizar_audio_privado, container, false)
    }
