...
class VisualizarImagemPrivadaDialogFragment : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(imageUrl: String, campoTexto: String, imageNameFirebase: String): VisualizarImagemPrivadaDialogFragment {
            val fragment = VisualizarImagemPrivadaDialogFragment()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dialog_visualizar_imagem_privada, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val campoTexto = arguments?.getString(ARG_CAMPO_TEXTO)
        val imageNameFirebase = arguments?.getString(ARG_IMAGE_NAME_FIREBASE)
